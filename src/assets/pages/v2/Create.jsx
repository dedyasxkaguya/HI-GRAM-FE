...
const Create = () => {
    ...
    const handlePost = () => {
        ...
        if (caption && category_id && imageElem) {
        ...
        <>
            ...
            <form action="" className='col-10 col-lg-6 mx-auto shadow rounded-4 p-4'>
                ...
                <div className="d-flex flex-column gap-2 mt-4">
                    <img src={image ? image : 'https://placehold.co/600x400?text=upload%20image%20here'} alt="" className='post-image-single rounded-4 w-50' />
